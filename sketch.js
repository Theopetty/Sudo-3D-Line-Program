...
if (key=='d'){}else{
if (key==0){}else{
mode=key;if (key=='4'){p6o7=2;}if (key=='6'){if (p6o7==2){}else{p6o7=0;background(0,250,0)}}if (key=='7'){if (p6o7==2){}else{p6o7=0;background(0,250,0)}}
}}}}}}
function keyReleased(){key=0;}
